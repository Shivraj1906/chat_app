...
COMMON_SOURCES = message.cpp socket_io.cpp chat_protocol.cpp secure_channel.cpp
CLIENT_SOURCES = client.cpp client_command.cpp $(COMMON_SOURCES)
SERVER_SOURCES = server.cpp client_registry.cpp $(COMMON_SOURCES)
PROXY_SOURCES = mitm_proxy.cpp message.cpp socket_io.cpp secure_channel.cpp
...
mitm_proxy: $(PROXY_SOURCES) message.h socket_io.h secure_channel.h key_exchange.h
